...
#input_cluster_file = "~/project/lactobacillus_genomics/fasta_clusters_lactobacillus_v3.txt"

cluster_data = read.table(input_cluster_file, header=FALSE, sep="\t")

num_sequences = cluster_data$V2
num_taxa = cluster_data$V3
min_per_taxon = cluster_data$V4
max_per_taxon = cluster_data$V6
...
plot(num_sequences, num_sequences/num_taxa, xlab="Total sequences in cluster", ylab="Average seqs per species",
